/****************************************************************************
** Meta object code from reading C++ file 'collection_0x33.h'
**
...
#error "The header file 'collection_0x33.h' doesn't include <QObject>."
...
const QMetaObject opa::Type0x33::staticMetaObject = {
    { &SvAbstractSignalCollection::staticMetaObject, qt_meta_stringdata_opa__Type0x33.data,
      qt_meta_data_opa__Type0x33,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *opa::Type0x33::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_opa__Type0x33.stringdata0))
        return static_cast<void*>(const_cast< Type0x33*>(this));
