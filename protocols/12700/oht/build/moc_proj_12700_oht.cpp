...
const QMetaObject oht::SvOHT::staticMetaObject = {
    { &modus::SvAbstractProtocol::staticMetaObject, qt_meta_stringdata_oht__SvOHT.data,
      qt_meta_data_oht__SvOHT,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *oht::SvOHT::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_oht__SvOHT.stringdata0))
        return static_cast<void*>(const_cast< SvOHT*>(this));
