...
#include <memory>
#include "../src/pgdb_stored_proc_aggregate.h"
...
void pgsp::pgStoredProcStorage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<pgStoredProcStorage *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject pgsp::pgStoredProcStorage::staticMetaObject = { {
    QMetaObject::SuperData::link<modus::SvAbstractStorage::staticMetaObject>(),
    qt_meta_stringdata_pgsp__pgStoredProcStorage.data,
    qt_meta_data_pgsp__pgStoredProcStorage,
    qt_static_metacall,
    nullptr,
    nullptr
} };
