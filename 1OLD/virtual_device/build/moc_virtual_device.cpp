...
struct qt_meta_stringdata_VirtualDeviceVirtualThread_t {
    QByteArrayData data[3];
    char stringdata0[33];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_VirtualDeviceVirtualThread_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_VirtualDeviceVirtualThread_t qt_meta_stringdata_VirtualDeviceVirtualThread = {
    {
QT_MOC_LITERAL(0, 0, 26), // "VirtualDeviceVirtualThread"
QT_MOC_LITERAL(1, 27, 4), // "stop"
QT_MOC_LITERAL(2, 32, 0) // ""

    },
    "VirtualDeviceVirtualThread\0stop\0"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_VirtualDeviceVirtualThread[] = {
...
void VirtualDeviceVirtualThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        VirtualDeviceVirtualThread *_t = static_cast<VirtualDeviceVirtualThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->stop(); break;
        default: ;
...
const QMetaObject VirtualDeviceVirtualThread::staticMetaObject = {
    { &VirtualDeviceGenericThread::staticMetaObject, qt_meta_stringdata_VirtualDeviceVirtualThread.data,
      qt_meta_data_VirtualDeviceVirtualThread,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};


const QMetaObject *VirtualDeviceVirtualThread::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *VirtualDeviceVirtualThread::qt_metacast(const char *_clname)
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_VirtualDeviceVirtualThread.stringdata0))
        return static_cast<void*>(const_cast< VirtualDeviceVirtualThread*>(this));
    return VirtualDeviceGenericThread::qt_metacast(_clname);
}

int VirtualDeviceVirtualThread::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = VirtualDeviceGenericThread::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
