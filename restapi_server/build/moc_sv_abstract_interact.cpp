...
QT_MOC_LITERAL(4, 39, 14), // "sv::log::Level"
QT_MOC_LITERAL(5, 54, 5), // "level"
QT_MOC_LITERAL(6, 60, 21), // "sv::log::MessageTypes"
QT_MOC_LITERAL(7, 82, 4), // "type"
QT_MOC_LITERAL(8, 87, 4) // "stop"

    },
    "modus::SvAbstractInteract\0message\0\0"
    "msg\0sv::log::Level\0level\0sv::log::MessageTypes\0"
    "type\0stop"
};
...
void modus::SvAbstractInteract::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (SvAbstractInteract::*_t)(const QString , sv::log::Level , sv::log::MessageTypes );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SvAbstractInteract::message)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject modus::SvAbstractInteract::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_modus__SvAbstractInteract.data,
      qt_meta_data_modus__SvAbstractInteract,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void modus::SvAbstractInteract::message(const QString _t1, sv::log::Level _t2, sv::log::MessageTypes _t3)
{
