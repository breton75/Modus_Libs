#ifndef GAMMA_SECURITY_IMITATOR_H
#define GAMMA_SECURITY_IMITATOR_H

#include <QMutex>
#include <QMutexLocker>

#include "gamma_security_imitator_global.h"
...
extern "C" {
    ...
    GAMMA_SECURITY_IMITATOR_EXPORT modus::SvAbstractProtocol* create();
...
namespace apak {
  ...
  class SvGammaSecurityImitator: public modus::SvAbstractProtocol
  {
    Q_OBJECT

  public:
    SvGammaSecurityImitator();
    ~SvGammaSecurityImitator();
...
#endif // GAMMA_SECURITY_IMITATOR_H
