...
#define P_TCP_RECV_PORT             "recv_port"
#define P_TCP_SEND_PORT             "send_port"
...
struct TcpParams {
  ...
  static TcpParams fromJsonString(const QString& json_string) //throw (SvException)
  {
    QJsonParseError err;
  ...
  static TcpParams fromJsonObject(const QJsonObject &object) //throw (SvException)
  {
    TcpParams p;
    QString P;
  ...
  QJsonObject toJsonObject() const
  {
    ...
    j.insert(P_TCP_RECV_PORT,         QJsonValue(static_cast<int>(recv_port)).toInt());
    j.insert(P_TCP_SEND_PORT,         QJsonValue(static_cast<int>(send_port)).toInt());
